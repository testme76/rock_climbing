    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <h1 className="text-3xl font-bold text-gray-900">Rock Climbing Tracker</h1>
          <p className="text-gray-600 mt-1">Track your progress, identify weaknesses, improve your climbing</p>
        </div>
      </header>
